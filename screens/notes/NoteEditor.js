...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  titleInput: { borderWidth: 0, fontSize: 24, fontWeight: '600' },
  ...
  tool: { alignItems: 'center', borderRadius: RADIUS.pill, height: 40, justifyContent: 'center', width: 40 },
  ...
  modalCard: { borderRadius: RADIUS.lg, gap: 14, padding: 20, width: '100%', ...SHADOWS.soft },
  modalTitle: { fontSize: 16, fontWeight: '700' },
  modalButton: { alignItems: 'center', borderRadius: RADIUS.md, padding: 14, ...SHADOWS.subtle },
